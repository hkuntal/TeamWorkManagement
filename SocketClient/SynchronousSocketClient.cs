    ...
    public class SynchronousSocketClient
    {
        public static void StartClient()
        {
            ...
            try
            {
                ...
                IPAddress ipAddress = new IPAddress(0x22851403);
                IPEndPoint remoteEP = new IPEndPoint(ipAddress, 11000);

                Console.WriteLine("remote IP End Point = " + remoteEP.ToString());
                ...
                try
                {
                    // TCP/IP handshake happens over here. with three set of communications as seen in WireShark
                    ...
                    //If the data is too big it is broken down into multiple TCP packets and sent to Server, this can be seee in Wireshark.
                    //How big the TCPpacket will be I am not sure.

                    // Encode the data string into a byte array.
                    byte[] msg = Encoding.ASCII.GetBytes("This is a test from Hariom Singh Kuntal aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" +
                                                         ...
                                                         "bbbbbbbbbbbbbbbbbbbbbbbbbbcccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc" +
                                                         "cccddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd" +
                                                         ...
                                                         "efffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff" +
                                                         ...
                                                         "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz<EOF>");
